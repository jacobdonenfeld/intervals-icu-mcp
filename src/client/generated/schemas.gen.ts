...
export const ActivitySchema = {
  ...
  properties: {
    ...
    analysis_issues: {
      type: "array",
      items: {
        $ref: "#/components/schemas/ActivityAnalysisIssue",
      },
    },
    pace: {
      type: "number",
...
export const EventExSchema = {
  ...
  properties: {
    ...
    training_availability: {
      type: "string",
      enum: ["NORMAL", "LIMITED", "UNAVAILABLE"],
    },
    max_training_time: {
      type: "integer",
      format: "int32",
...
export const AthleteTrainingAvailabilitySchema = {
  type: "object",
  properties: {
    day_of_week: {
      type: "integer",
...
export const AthleteUpdateDTOSchema = {
  ...
  properties: {
    ...
    training_availability: {
      type: "array",
      items: {
        $ref: "#/components/schemas/AthleteTrainingAvailability",
      },
    },
    recalcHrZones: {
      type: "boolean",
...
export const SportSettingsSchema = {
  ...
  properties: {
    ...
    update_activity_name_from_workout: {
      type: "boolean",
    },
    created: {
      type: "string",
    ...
    calendar_tile_activity_panel_id: {
      type: "integer",
      format: "int32",
    },
    other: {
...
export const UpdateStreamsResultSchema = {
  type: "object",
  properties: {
    updated: {
      type: "array",
...
export const ActivityAnalysisIssueSchema = {
  type: "object",
  properties: {
    type: {
      type: "string",
...
export const SendResponseSchema = {
  type: "object",
  properties: {
    id: {
      type: "integer",
...
export const ApplyPlanDTOSchema = {
  type: "object",
  properties: {
    start_date_local: {
      type: "string",
...
export const NewCustomItemSchema = {
  type: "object",
  properties: {
    id: {
      type: "integer",
    ...
    required_items_created: {
      type: "array",
      items: {
        $ref: "#/components/schemas/NewCustomItem",
      },
    },
  },
} as const;
...
export const WithCoursesSchema = {
  type: "object",
  properties: {
    id: {
      type: "integer",
...
export const AthleteForProfileSchema = {
  type: "object",
  properties: {
    id: {
      type: "string",
...
export const AthleteProfileSchema = {
  ...
  properties: {
    athlete: {
      $ref: "#/components/schemas/AthleteForProfile",
    },
    sharedFolders: {
      type: "array",
      items: {
